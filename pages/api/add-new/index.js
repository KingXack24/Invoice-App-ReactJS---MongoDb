...
async function handler(req, res) {
    ...
    // const client = MongoClient.connect('mongodb+srv://Admin:<password>@atlascluster.spvvehc.mongodb.net/?retryWrites=true&w=majority')

    const client = await MongoClient.connect('mongodb+srv://Zack:7k0c3YA24XFGomv8@atlascluster.spvvehc.mongodb.net/invoices2?retryWrites=true&w=majority', {useNewUrlParser: true});
